...
public class Simple_commands {
	...
	public void testcase4() throws InterruptedException {
		wb.findElement(By.xpath("//*[@name='userName']")).sendKeys("saksham@gmail.com");
		Thread.sleep(3000);
		wb.findElement(By.xpath("//*[@name='password']")).sendKeys("Saksham@35");
		Thread.sleep(3000);
	...
	public void testcase7() throws AWTException, InterruptedException {
		...
		for(int i=0;i<=1;i++)
		{
			wb.findElement(By.id("windowButton")).click();    // to open the window as many no. of time as much we have the tabs recent opean
			// it will switch to the other tab in the below line
			//wb.switchTo().window(handles);
			Thread.sleep(3000);
		}
